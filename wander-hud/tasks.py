...
"""
from env import (find_red_ball, find_red_ball_3d, find_red_ball_3d_sym,  # noqa: F401
                 env)  # env re-exported for `hud eval`
...
# 3D SYMBOLIC tasks (match the multi-turn 3D RFT model's training distribution).
_t3s0 = find_red_ball_3d_sym(scene="train", seed=0); _t3s0.slug = "find-ball-3d-sym-0"
_t3s1 = find_red_ball_3d_sym(scene="train", seed=1); _t3s1.slug = "find-ball-3d-sym-1"

tasks = [_t0, _t1, _t2, _t3d_test, _t3d_train, _t3s0, _t3s1]
